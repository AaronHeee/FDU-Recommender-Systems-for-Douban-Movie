...
Modified By Zhankui He for Recommender System for initialing by pretrained embeddings
'''
import math
import os
import numpy as np
...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='douban-plus-1-06-08',
    ...
    parser.add_argument('--feature_length', type=int, default=55000,
                    help='When None: the feature length will be detected from files')
    parser.add_argument('--user_num', type=int, default=5000)
    parser.add_argument('--embedding_path', type=str, default="embedding/movie-deepwalk-128.embedding.npy")
...
class FM(BaseEstimator, TransformerMixin):
    ...
    def _initialize_weights(self):
        ...
        if self.pretrain_flag > 0:
            ...
            embedding[self.args.user_num:height+self.args.user_num, :width] = embedding_input
