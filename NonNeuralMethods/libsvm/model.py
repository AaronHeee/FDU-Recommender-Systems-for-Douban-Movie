...
fold = '../../neural_factorization_machine/data/douban-05-20/'
train_path = fold+'douban-05-20.test.libfm'
valid_path = fold+'douban-05-20.train.libfm'
...
# 将训练出的分类模型保存为 m
print('Training...')
m = svm_train(y_train, x_train, '-c 4 -h 0')    # -s 3
